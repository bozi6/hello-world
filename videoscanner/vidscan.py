...
class VideoScanner:
    ...
    def _setup_main_sheet(self):
        ...
        headers = ['Sorszám', 'Fájl elérési út', 'Fájlnév', 'Hossz (óó:pp:mm)', 'Létrehozás dátuma', 'Fájlméret (MB)']
        ...
        self.main_sheet.column_dimensions['E'].width = 20
        self.main_sheet.column_dimensions['F'].width = 15
    ...
    def _setup_year_sheet(self, year):
        ...
        if year not in self.year_sheets:
            ...
            headers = ['Sorszám', 'Fájl elérési út', 'Fájlnév', 'Hossz (óó:pp:mm)', 'Létrehozás dátuma',
                       'Fájlméret (MB)']
    ...
    def get_video_duration(self, file_path):
        """Meghatározza a videó hosszát ffprobe segítségével"""
        try:
            cmd = [
            ...
            if result.returncode == 0:
                ...
                # Konvertálás óó:pp:mm formátumra
    ...
    def get_file_info(self, file_path):
        ...
        try:
            ...
            return {
                'creation_date': modification_time.strftime('%Y-%m-%d %H:%M:%S'),
                'creation_year': modification_time.year,
                'size_mb'      : size_mb
            }
        except OSError:
            return {
                'creation_date': 'Ismeretlen',
                'creation_year': None,
                'size_mb'      : 0
            }

    def add_video_to_sheets(self, file_path, file_info, duration):
        ...
        if file_info['creation_year']:
            year = file_info['creation_year']
        ...
        try:
            for file_path in directory.rglob('*'):
                if file_path.is_file() and file_path.suffix.lower() in self.video_extensions:
                    ...
                    # Videó hossz lekérése
                    duration = self.get_video_duration(file_path)

                    # Hozzáadás a munkalapokhoz
                    self.add_video_to_sheets(file_path, file_info, duration)
...
def main():
    ...
    try:
        ...
        print("Figyelem: ffprobe nem található. A videók hossza 'Hiba'-ként jelenik meg.")
        print("FFmpeg telepítése szükséges a videó hossz meghatározásához.")
