...
for tengelyek in egysor:
    ...
    if tengelyek == 'K' or tengelyek == 'N':
        kn += 1
print('2b feladat')
print('{} lépést kell megtenni az ED, {} lépést az KN tengely mentén'.format(ed, kn))
...
print('A robotka legmesszebb a {} lépésben, {:.3f} távolságra volt'.format(lepesszam, math.sqrt(maxtav)))
