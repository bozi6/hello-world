"""Generate funny names by randomly combining names from 2 seaprate lists."""
#  pseudonyms.py Copyright (C) 2024  Konta Boáz
#   Last Modified: 2024. 12. 17. 23:53
...
def main():
    ...
    first = ('Baby Oil', 'Bad News', 'Big Burps', "Bill 'Beenie-Weenie",
             ...
             'Dicman', 'Elphonso', 'Fancypants', 'Figgs', 'Foncy',
             'Gootsy', 'Greasy Jim', 'Huckleberry', 'Huggy', 'Ignatious',
             'Jimbo', "Joe 'Pottin Soil'", 'Johnny', 'Lemongrass',
             'Lil Debil', 'Longbranch', '"Lunch Money"',
    ...
    last = ('Appleyard', 'Bigmeat', 'Bloominshine', 'Boogerbottom',
            ...
            'Overturf', 'Oxhandler', 'Pealike', 'Pennywhistle',
            'Peterson', 'Pieplow', 'Pinkerton', 'Porkins',
            'Putney', 'Quakenbush', 'Rainwater', 'Rosenthal',
            'Rubbins', 'Sackrider', 'Snuggleshine',
            'Splern', 'Stevens', 'Stroganoff', 'Sugar-Gold',
            'Swackhamer', 'Tippins', 'Turnipseed',
